...
服务名：/uat/UAT_AuthenCtl

服务类型：mavros_msgs::UAT_AuthenCtl
...
说明：由认证节点发出，用于传输connect阶段需要字段。mqtt_client的connect依赖此服务触发。



消息名：/uat/UAT_MqttAuthenStatus

消息类型：mavros_msgs::UAT_MqttAuthenStatus
...
说明：mqtt_client节点自身以1hz发布，用于标识当前设备类型及connect状态。所有mqtt消息需要根据该状态位使能或停止发送。
