 ...
 * @note IPv4 only
 */
class MAVConnUDPMulticast : public MAVConnInterface,
	public std::enable_shared_from_this<MAVConnUDPMulticast> {
public:
	 ...
	 */
	MAVConnUDPMulticast(uint8_t system_id = 1, uint8_t component_id = MAV_COMP_ID_UDP_BRIDGE,
			...
			bool multicast_state=false);
	virtual ~MAVConnUDPMulticast();
